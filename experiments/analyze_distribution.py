...
Also supports Experiment 4 (if present):
- Propagation alignment cosine similarity distributions
"""
...
def main():
    ...
    # Analyze Experiment 4: Propagation Alignment (Local vs Downstream)
    if 'experiment4_propagation_alignment' in results:
        print_experiment_stats(
            "EXPERIMENT 4: Propagation Alignment (Local vs Downstream)",
            results['experiment4_propagation_alignment'],
            layers,
            cosine_bins,
            value_key='per_sample_similarities'
        )
        ...
        print(f"\n{'='*100}")
        print("EXPERIMENT 4: Propagation Alignment (Local vs Downstream)")
        print(f"{'='*100}")
        print("(Not found in this result file; likely generated by an older compare_h_z.py)")
    ...
    if 'experiment4_propagation_alignment' in results:
        print(f"\n📊 Experiment 4 (Propagation Alignment) - Mean Cosine Similarity by Layer:")
        for layer in layers:
