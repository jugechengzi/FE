"""
AlphaEdit FE implementation with precomputed Z cache support. (2-alphaedit_main.py)
"""
import os
...
def apply_alphaedit_to_model(
    ...
    v_num_grad_steps = cfg.llms.get("v_num_grad_steps", None)
    ...
    for layer in cfg.llms.layers:
        ...
        if v_lr is not None and v_num_grad_steps is not None:
            cache_zs_file += f"-vlr{v_lr}-steps{v_num_grad_steps}"
